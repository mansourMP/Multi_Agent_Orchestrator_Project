...
const TOOL_DIRECTORY: Record<SetupToolId, SetupTool> = {
  gmail: {
    ...
    connectHref: `/connectors?onboarding=1&connector=google_workspace&return_to=${SETUP_RETURN_TO}`,
    supported: true,
    blocking: true,
  },
  slack: {
    ...
    connectorId: 'slack',
    connectHref: `/connectors?onboarding=1&connector=slack&return_to=${SETUP_RETURN_TO}`,
    supported: true,
    blocking: false,
  },
  notion: {
    ...
    connectorId: null,
    connectHref: `/connectors?onboarding=1&return_to=${SETUP_RETURN_TO}`,
    supported: false,
    blocking: false,
  },
  calendar: {
