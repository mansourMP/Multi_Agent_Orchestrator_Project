...
| Streaming responses | ✅ | ✅ | — |
| Multi-channel inbox | ✅ 20+ channels unified | ✅ 7 channels (Telegram, WhatsApp, Slack, Discord, Email, Web Chat, API) | OpenClaw has more channels (Signal, iMessage, IRC, Matrix, LINE, etc.) |
