...
- Examples in the extension contract include GitHub, Linear, Notion, Gmail,
  Calendar, Drive, Dropbox, Amazon S3, SMTP / IMAP, WeChat Work, Instagram
  Business, and Microsoft 365. Webhooks are planned until signed ingress and
