...
| Example targets | WhatsApp personal, Telegram personal, future local browser/app acting as the user | Telegram bot, Twilio WhatsApp, Slack, Discord, GitHub, email, phone |
...
- Twilio WhatsApp
- Slack / Discord / GitHub / email / phone integrations
