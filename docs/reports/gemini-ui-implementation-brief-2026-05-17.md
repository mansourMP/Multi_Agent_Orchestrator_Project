...
1. `docs/platform/frontend-map.md`
2. `docs/reports/studio-agents-launch-readiness-2026-05-15.md`
3. `docs/domains/studio/ai-provider-credits-strategy-2026-05-16.md`
4. `docs/decisions/architectural-decisions.md`
