...
| Channel access | Personal WhatsApp/Telegram through Gateway | `personal_channels_service.py` |
...
| Channel access | Business/official channels: Telegram Bot, WhatsApp Cloud, Web Chat, Email, Slack, Discord | `channel_lane_contract_service.py:88-116` |
...
1. **trace_id missing from channel auto-replies** — automatic replies to WhatsApp/Telegram have no trace correlation. Fix before Phase C.
