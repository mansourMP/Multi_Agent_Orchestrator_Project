    ...
    runtimeTargets: [
      {
        ...
        status: 'ready',
        statusLabel: 'Ready',
        statusReason: 'Cloud execution is ready and remains the default path for ordinary turns.',
        description: 'Cloud-hosted execution for the workspace.',
        connectionMode: 'platform_cloud',
        executionTarget: 'cloud',
        trustTier: 'hosted_high',
        approvalMode: 'policy_bound',
        sampleAttachmentLabel: 'Preview Cloud',
      },
      {
        id: 'local_companion',
        ...
        statusReason: 'No local companion is paired to this workspace yet, so Sage stays in cloud mode.',
        description: 'Paired local companion execution.',
        connectionMode: 'platform_relay',
        executionTarget: 'local_companion',
        trustTier: 'paired_local_privileged',
        approvalMode: 'explicit_owner_approval',
        sampleAttachmentLabel: null,
      },
    ],
  },
  shellHints: {
