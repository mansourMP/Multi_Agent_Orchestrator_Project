...
const VisionNode = ({ data, selected }: { data: VisionNodeData; selected?: boolean }) => {
    const [isHovered, setIsHovered] = useState(false);
    const accentColor = '#a855f7'; // Purple for vision
        ...
        >
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Eye size={24} color={accentColor} strokeWidth={1.5} />
                    <div style={{
                        position: 'absolute',
                        top: -2,
                        right: -2,
