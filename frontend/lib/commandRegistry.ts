...
const BASE_COMMANDS: PlatformCommand[] = [
  ...
  },
  {
    id: 'nav.setup',
    title: 'Go to Setup',
    description: 'Launch the assistant by confirming runtime, account mode, and first connections.',
    group: 'Navigate',
  ...
  },
  {
    ...
    description: 'Open advanced workspace controls, readiness, diagnostics, and history.',
    group: 'Navigate',
    keywords: ['advanced', 'diagnostics', 'setup', 'control center', 'history'],
    action: { type: 'navigate', href: '/control-center' },
  },
  {
    id: 'nav.workspace',
    title: 'Go to Advanced Workspace',
    description: SINGLE_AGENT_MODE ? 'Open the advanced assistant control and inspection workspace.' : 'Open the advanced routing and inspection workspace.',
    group: 'Navigate',
    keywords: SINGLE_AGENT_MODE ? ['advanced workspace', 'assistant', 'inspect', 'console'] : ['advanced workspace', 'routing', 'inspect', 'console'],
