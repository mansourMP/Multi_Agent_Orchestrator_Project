...
const DEMO_STEPS: readonly DemoStep[] = [
  ...
  },
  {
    ...
    number: 7,
    title: 'Billing',
    description: 'Usage metering and cost estimation are visible; live payment collection stays gated.',
    proofPoint: 'AI token and connector-read line items with pricing-registry estimates, not live subscription processing.',
    routeId: 'settings',
