...
DEFAULT_AGENT_DEFINITIONS: List[Dict[str, Any]] = [
    {
        ...
        "description": "Plan work, summarize context, draft communications, and coordinate follow-through across your workspace.",
        "category": "Operations",
        "icon": "sparkles",
        ...
        "manifest": {
            ...
            "default_prompt": "Act as an executive assistant for planning, coordination, and concise execution support.",
        },
        "capability_manifest": {
            "toggles": [
                {"id": "web_search", "label": "Web Search", "description": "Research live information when needed.", "default_enabled": True},
                {"id": "file_access", "label": "File Access", "description": "Read and organize files inside granted folders.", "default_enabled": True},
                {"id": "external_api", "label": "External API", "description": "Use approved connectors and external systems.", "default_enabled": True},
                {"id": "shell.execute", "label": "Shell Access", "description": "Run trusted local shell commands when approved.", "default_enabled": False},
            ],
        },
    ...
    },
    {
        "slug": "web-researcher",
        "name": "Web Researcher",
        "description": "Search, synthesize, and brief topics with citations and structured findings.",
        "category": "Research",
        "icon": "search",
        "agent_kind": "specialist",
        "visibility": "workspace",
        "manifest": {
            "template_kind": "generic_operator",
            "default_prompt": "Act as a precise web researcher. Find sources, compare evidence, and summarize clearly.",
        },
        "capability_manifest": {
            "toggles": [
                {"id": "web_search", "label": "Web Search", "description": "Search and fetch public information.", "default_enabled": True},
                {"id": "external_api", "label": "External API", "description": "Use approved external systems for enrichment.", "default_enabled": True},
                {"id": "file_access", "label": "File Access", "description": "Store notes and reports inside granted folders.", "default_enabled": False},
            ],
        },
        "policy_manifest": {"trust_mode": "guarded", "interactive_approvals": True},
    ...
    },
    {
        ...
        "description": "Control the local machine, operate applications, and complete device-bound tasks under governance.",
        ...
        "manifest": {
            "template_kind": "generic_operator",
            "default_prompt": "Act as a careful desktop operator that uses local tools only within granted scope.",
        },
        "capability_manifest": {
            "toggles": [
                {"id": "computer_control", "label": "Computer Control", "description": "Move the mouse, click, type, and interact with desktop apps.", "default_enabled": True},
                {"id": "shell.execute", "label": "Shell Access", "description": "Run local commands on the assigned machine.", "default_enabled": True},
                {"id": "file_access", "label": "File Access", "description": "Read and modify files within granted folders.", "default_enabled": True},
                {"id": "web_search", "label": "Web Search", "description": "Use web tools while working locally.", "default_enabled": False},
            ],
        },
        "policy_manifest": {"trust_mode": "guarded", "interactive_approvals": True},
        "placement_manifest": {"preferred_runtime_slug": "my-local-mac", "allowed_runtime_classes": ["desktop_companion"]},
    },
]
...
DEFAULT_MASTER_AGENT_DEFINITION: Dict[str, Any] = {
    "slug": "sage",
    "name": "Sage",
    "description": "The master orchestrator for this workspace. Sage owns the primary relationship and delegates to installed specialists.",
    "category": "System",
    "icon": "sparkles",
    "agent_kind": "master",
    "visibility": "private",
    "manifest": {
        ...
        "default_prompt": "You are Sage, the primary orchestrator for this workspace. Maintain the user relationship, route work to installed specialists when appropriate, and stay within policy.",
    },
    "capability_manifest": {
        "toggles": [],
    },
