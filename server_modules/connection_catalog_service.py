...
_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    _item(
        ...
        description="Planned · Personal Signal through the selected Agent Computer Signal bridge.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
    ...
    _item(
        ...
        launch_status=LAUNCH_PLANNED,
        description="Planned · Personal iMessage through a selected Mac Agent Computer BlueBubbles bridge.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
    ...
    _item(
        ...
        setup_kind="local_bridge",
        launch_status=LAUNCH_PLANNED,
        description="Planned · Personal WeChat through a selected Agent Computer bridge implementing the Empyralis local-bridge contract.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
