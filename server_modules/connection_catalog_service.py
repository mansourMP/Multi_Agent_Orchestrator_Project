...
_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    _item(
        ...
        description="Personal Signal through the selected Agent Computer Signal bridge. Planned — bridge contract not yet live.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
    ...
    _item(
        ...
        launch_status=LAUNCH_PLANNED,
        description="Personal iMessage through a selected Mac Agent Computer BlueBubbles bridge. Planned — bridge contract not yet live.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
    ...
    _item(
        ...
        setup_kind="local_bridge",
        launch_status=LAUNCH_PLANNED,
        description="Personal WeChat through a selected Agent Computer bridge implementing the Empyralis local-bridge contract. Planned — bridge contract not yet live.",
        requires_gateway=True,
        supports_inbound=True,
        supports_outbound=True,
        media_support=_media(text=True),
