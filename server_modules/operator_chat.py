...
globals().update(
    direct_chat_operator_binding_service.build_direct_chat_shell_export_map(
        shell_bindings=_direct_chat_shell_bindings,
    )
)
...
globals().update(
    direct_chat_operator_binding_service.build_direct_chat_runtime_export_map(
        binding_bundle=_direct_chat_binding_bundle,
        preview_run_response_fn=_direct_chat_tool_routing_bindings.preview_run_response,
        prefer_durable_run_handoff_fn=_direct_chat_tool_routing_bindings.prefer_durable_run_handoff,
    )
)
