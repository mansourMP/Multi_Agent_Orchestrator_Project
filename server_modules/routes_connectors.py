...
router.add_api_route("/connectors/vault/{connector_id}/microsoft-drive", actions.browse_microsoft_connector_drive, methods=['GET'], dependencies=[Depends(require_api_key)])
...
router.add_api_route("/connectors/vault", actions.create_connector_vault, methods=['POST'], dependencies=[Depends(require_api_key)])
router.add_api_route("/connectors/vault/{credential_id}", actions.update_connector_vault, methods=['PATCH'], dependencies=[Depends(require_api_key)])
router.add_api_route("/connectors/vault/{credential_id}/test", actions.test_connector_vault, methods=['POST'], dependencies=[Depends(require_api_key)])
router.add_api_route("/connectors/vault/{credential_id}", actions.delete_connector_vault, methods=['DELETE'], dependencies=[Depends(require_api_key)])
router.add_api_route("/credentials/vault", actions.create_vault_credential, methods=['POST'], dependencies=[Depends(require_api_key)])
router.add_api_route("/credentials/vault/{credential_id}", actions.delete_vault_credential, methods=['DELETE'], dependencies=[Depends(require_api_key)])
router.add_api_route("/credentials/vault/{credential_id}/test", actions.test_vault_credential, methods=['POST'], dependencies=[Depends(require_api_key)])
