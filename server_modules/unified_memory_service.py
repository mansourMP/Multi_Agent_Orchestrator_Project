...
def _cloud_synced_layer(*, event_layer: Dict[str, Any], audience: str) -> Dict[str, Any]:
    ...
    layer["summary"] = {
        "count": len(layer["items"]),
        "synced_sources": ["personal_context_events"],
...
async def build_sage_memory_payload(
    *,
    ...
    cloud_synced_layer = _cloud_synced_layer(event_layer=event_layer, audience="sage")
    layers = {
...
async def build_specialist_memory_payload(
    *,
    ...
    cloud_synced_layer = _cloud_synced_layer(event_layer=event_layer, audience="specialist")
    layers = {
        "profile_memory": profile_layer,
        "episodic_memory": episodic_layer,
        "app_event_history": event_layer,
