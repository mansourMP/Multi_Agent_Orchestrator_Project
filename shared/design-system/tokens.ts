...
export const DESIGN_SYSTEM_BRAND_COLORS = {
  light: {
    ...
    borderStrong: '#E0E0E0',
    borderMuted: 'rgba(17, 17, 17, 0.05)',
    text: '#111111',
    textMuted: '#666666',
    textSoft: 'rgba(102, 102, 102, 0.72)',
    primary: '#EEEEEE',
    primaryMuted: 'rgba(238, 238, 238, 0.64)',
    highlight: '#E6E6E6',
    warning: '#666666',
    warningMuted: 'rgba(102, 102, 102, 0.12)',
    success: '#666666',
    successMuted: 'rgba(102, 102, 102, 0.12)',
    error: '#666666',
    errorMuted: 'rgba(102, 102, 102, 0.12)',
  },
  dark: {
    app: '#1A1A1A',
    sidebar: '#242424',
    ...
    borderStrong: '#333333',
    borderMuted: 'rgba(240, 240, 240, 0.05)',
    text: '#F0F0F0',
    textMuted: '#888888',
    textSoft: 'rgba(136, 136, 136, 0.72)',
    primary: '#2E2E2E',
    primaryMuted: 'rgba(46, 46, 46, 0.72)',
    highlight: '#3A3A3A',
    warning: '#888888',
    warningMuted: 'rgba(136, 136, 136, 0.16)',
    success: '#888888',
    successMuted: 'rgba(136, 136, 136, 0.16)',
    error: '#888888',
    errorMuted: 'rgba(136, 136, 136, 0.16)',
  },
} as const;
